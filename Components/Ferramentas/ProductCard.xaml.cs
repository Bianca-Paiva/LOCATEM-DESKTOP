...
{
    /// <summary>
    /// Card de ferramenta — migrado de
    /// components/Ferramentas/ProductCard/ProductCard.tsx.
    /// </summary>
    public partial class ProductCard : ContentView
    {
        ...
        public static readonly BindableProperty ImagemProperty =
            BindableProperty.Create(
                ...
                typeof(ProductCard),
                string.Empty,
                propertyChanged: OnImagemChanged);

        public string Imagem
        {
            get => (string)GetValue(ImagemProperty);
        ...
        public static readonly BindableProperty ReviewCountTextoProperty =
            BindableProperty.Create(
                nameof(ReviewCountTexto),
                typeof(string),
                typeof(ProductCard),
                "(0)");

        public string ReviewCountTexto
        {
            get => (string)GetValue(ReviewCountTextoProperty);
            private set => SetValue(ReviewCountTextoProperty, value);
        }

        public static readonly BindableProperty StatusProperty =
            BindableProperty.Create(
                nameof(Status),
                typeof(StatusFerramenta),
                typeof(ProductCard),
                StatusFerramenta.Disponivel);

        public StatusFerramenta Status
        {
            get => (StatusFerramenta)GetValue(StatusProperty);
        ...
        public bool MostrarAcoes
        {
            get => (bool)GetValue(MostrarAcoesProperty);
            set => SetValue(MostrarAcoesProperty, value);
        }
        ...
        {
            get => (ICommand?)GetValue(VerCommandProperty);
            set => SetValue(VerCommandProperty, value);
        }
        ...
        private static void OnReviewCountChanged(
            ...
            object newValue)
        {
            ((ProductCard)bindable).ReviewCountTexto =
                $"({newValue})";
        }
        ...
        private static void OnImagemChanged(
            ...
            object newValue)
        {
            if (bindable is not ProductCard view)
                return;
            ...
            // Para MauiImage em Resources/Images,
            // basta usar o nome do arquivo.
            view.ProductImage.Source =
                ImageSource.FromFile(raw);
        }
    }
}